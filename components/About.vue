<template>
  <UContainer class="mt-28 flex flex-wrap justify-between items-center gap-20">
    <div class="m-auto xl:m-0">
      ...
      <h1
        class="font-extrabold text-5xl bg-gradient-to-r from-white to-zinc-500 bg-clip-text py-1 text-transparent"
      >
        Front-end Developer
      </h1>
    ...
    <div class="relative m-auto xl:m-0 group">
      <UCard
      ...
      <UCard
        class="rounded-2xl absolute top-0 w-full h-full rotate-6 -z-10 backdrop-blur-3xl hidden sm:flex group-hover:rotate-0 transition-all"
        :ui="{ background: '' }"
      />
      <UCard
